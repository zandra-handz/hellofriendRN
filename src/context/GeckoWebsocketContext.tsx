...
//   ) => boolean;
//   sendFETextToGecko: (message: string) => void;
// };
...
//               wsRef.current.send(
//                 JSON.stringify({ action: "get_score_state" }),
//               );
//             }
//           }, msUntilExpiry);
//         }
...
//   const sendFETextToGecko = useCallback((message) => {
