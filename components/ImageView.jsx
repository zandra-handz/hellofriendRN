...
const ImageView = ({ imageData, navigationArrows, onSliderPull, isModalVisible, toggleModal }) => {
 ...
 // };
  ...
  const handleShare = async () => {
    ...
    const fileUri = FileSystem.documentDirectory + (imageData.title || 'shared_image') + '.jpg';
    ...
    <>
      ...
      <View style={[styles.modalContainer, themeStyles.genericTextBackground]}> 
          ...
          <View 
              ...
              >
                <HeaderBaseItemView onBackPress={toggleModal} itemData={imageData} onSliderPull={onSliderPull} headerTitle={'VIEW IMAGE'} />
                  
                <View style={[styles.imageContainer, themeStyles.textGenericBackgroundShadeTwo]}>
                   
                    <View style={styles.categoryContainer}>
                      <Text style={[styles.imageText, themeStyles.genericText]}>{imageData.title}</Text>
                    </View>
