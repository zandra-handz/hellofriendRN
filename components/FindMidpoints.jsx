...
const FindMidpoints = ({ size = 14, family = 'Poppins-Regular', color = "black", style }) => {
    ...
    const handleCalculate = () => {
        ...
        setShowResults(true); // Show results page when button is pressed
    };

    // Toggle back to main page
    const handleBack = () => {
