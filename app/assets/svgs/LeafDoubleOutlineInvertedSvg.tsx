  ...
  <Svg width={width} height={height} viewBox="0 0 512 512">
    <G stroke={stroke} strokeWidth={strokeWidth} fill={fill}>
      ...
      <Path
        ...
        transform=" rotate(0)  translate(-20, -34)"
      /> 
      ...
      <Path
        ...
        transform=" scale(.85) translate(20, 34)"
      />
...
{/* <Path
  d="
    M69.18,193.54
    C32.89,156.75,37.36,96,44.54,59.12
    c6.77,23.33,24.41,55.45,68.79,86.63
    c36.42,25.6,53.15,53.14,60.65,75.09
    C158.74,225.73,111.11,236,69.18,193.54Z
  "
  transform="scale(.85) translate(20, 34)"
  fill={fill}
  stroke={fill}
...
<Path
  d="
    M183.87,213.35
    C204.31,178,199,196.41,198.25,159.52
    C192.36,132.91,153.41,100.27,114.77,92.73
    C86.34,86.55,69,74.7,58.19,62.67
    C65.74,82.94,82.67,109.61,120.19,136
    C157.09,161.94,175.14,190,183.87,213.35Z
  "
  transform="scale(.85) translate(20, 34)"
  fill={fill}
  stroke={fill}
...
{/* <Path
  d="M458.36,92.55a5.8,5.8,0,0,0-4.68-3.28A5.65,5.65,0,0,0,447,93C441.38,159,410.38,178.29,359,210.33c-27.07,16.89-60.76,37.91-98.23,70.82-47.43,41.65-68.28,79.3-62,111.88,6.15,31.82,36.1,48.44,48.57,54.08a156.52,156.52,0,0,0-5.18,39.3,6,6,0,0,0,6,5.81h.16a6,6,0,0,0,5.81-6.12,146.18,146.18,0,0,1,4.65-35.58c82.5,14.37,143.51,0,181.28-42.74C526.3,310.15,461.17,101.4,458.36,92.55Z"
  transform="translate(-20, -34) scale(0.85) translate(20, 34)"
