...
//   console.log(this.autoSelectCoord)
// }
...
updateCurrentPos(momentsRef, aspect, scale) {
  ...
  while (tries < moments.length) {
    ...
    // more for testing because it is annoying for the gecko to get stuck standing still on these
    // 🚫 skip invalid/offscreen moments
    if (currentMoment.coord[0] === -100) {
      this.currentIndex = (this.currentIndex + 1) % moments.length;
      tries++;
      continue;
