...
export default class FollowerLegs {
  ...
  resetStepsOnForward() {
    ...
    this.stepTargets[0][0] = s0[0];
    this.stepTargets[0][1] = s0[1];
    this.stepTargets[0].angle = s0.angle;

    this.stepTargets[1][0] = s1[0];
    this.stepTargets[1][1] = s1[1];
    this.stepTargets[1].angle = s1.angle;
