...
const OutlinedText = ({
  ...
  <View style={styles.outlineContainer}>
    <Text
      style={[
        style,
        { color: OUTLINE_COLOR, position: "absolute", left: -OUTLINE_R },
      ]}
    >
      {text}
    </Text>
    ...
    <Text
      style={[
        style,
        { color: OUTLINE_COLOR, position: "absolute", top: -OUTLINE_R },
      ]}
    >
      {text}
    </Text>
    ...
    <Text
      style={[style, { color: SHADOW_COLOR, position: "absolute", top: 3 }]}
    >
      {text}
    </Text>
...
const Momes = ({
  ...
  const { navigateToImages, navigateToMoments } = useAppNavigations();
            ...
            {!loadingDash && (
              <View style={styles.rowJustifyEnd}>
                ...
                <View style={styles.rightButtonGroup}>
                  <GlobalPressable hitSlop={10} onPress={navigateToMoments}>
                    <OutlinedText
                      text="List view"
                      color={primaryColor}
