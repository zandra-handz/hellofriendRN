...
// + BOUNCY, PILL DROPS DOWN TOO, INDISCRIMINATELY/NO TIMESTAMP CHECK
...
//   const pillTranslateY = useSharedValue(-600);
...
//       // Pill drops in from well above screen
//       pillTranslateY.value = withTiming(-600, { duration: 0 });
//       pillOpacity.value = withTiming(1, { duration: 0 });
//       pillTranslateY.value = withSpring(0, PILL_ENTRANCE_SPRING);
...
//   return (
//     // overflow visible all the way down so pill is visible above its layout position
//     <View style={styles.wrapper}>
//       <View style={styles.iconsContainer} pointerEvents="none">
//         <Animated.View
//           style={[animatedPinStyle, styles.animatedIcon,
...
//       <Animated.View style={[styles.pillAnimatedWrapper, pillAnimatedStyle]}>
//         <Pressable
//           onPress={handleOnPress}
//           onLongPress={toggleLockOnFriend}
//           style={[styles.pill, { backgroundColor: PILL_BG }]}
...
// // Bouncy entrance for the pill itself
// const PILL_ENTRANCE_SPRING = {
//   damping: 20,
//   stiffness: 150,
//   mass: 0.2,
...
//       // Pill bounces in from above
//       pillTranslateY.value = withTiming(-60, { duration: 0 });
//       pillOpacity.value = withTiming(1, { duration: 0 });
//       pillTranslateY.value = withSpring(0, PILL_ENTRANCE_SPRING);

//       // Content drops in or fades in after pill arrives
//       if (friendChangeTimestamp) {
//         triggerDropIn();
//       } else {
//         triggerFadeIn();
...
// drops down into pill, no bounce
import { StyleSheet, View, Text, Pressable } from "react-native";
import React, { useCallback, useMemo, useEffect, useState } from "react";
import useFriendDash from "@/src/hooks/useFriendDash";
import { useFocusEffect } from "@react-navigation/native";
