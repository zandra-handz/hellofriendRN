...
import UpArrowNoStemSolidSvg from "@/app/assets/svgs/up-arrow-no-stem-solid.svg";

import RotatableToggleButton from "@/app/components/appwide/button/RotatableToggleButton";
...
const ExpandableUpCard = ({
  content,
  useParentButton = false,
  ...
  const animatedStyle = useAnimatedStyle(() => {
    return {
      height: withTiming(cardHeight.value, { duration: 200 }), // Smooth transition
    };
  });
