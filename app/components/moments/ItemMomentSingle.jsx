...
import ThoughtBalloonLightBlueSvg from '@/app/assets/svgs/thought-balloon-light-blue.svg';
    ...
    <View style={styles.imageContainer}>
      <TouchableOpacity onPress={openModal}>
        <View style={[styles.relativeContainer, { width: momentWidth || windowWidth / 2 - 80, height: momentHeight || windowWidth / 2 - 80 }]}>
          <ThoughtBalloonLightBlueSvg width={momentWidth} height={momentHeight} color={svgColor} style={styles.svgImage} />
