    ...
    >
      <SafeAreaView style={styles.safeAreaStyle}>
        <>
          ...
          {/* Leaf positioned like ScreenMomentView — top-left, no rotation */}
          <Image
            source={LeafImage}
...
const styles = StyleSheet.create({
  ...
  // Matches ScreenMomentView leafWrapper + leaf positioning
  leafContainer: {
    position: "absolute",
    top: -170,
    left: -300,
...
export default SafeViewMomentView;