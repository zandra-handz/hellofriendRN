...
import MomentAdded from "@/app/components/moments/MomentAdded";
import ModalSelectMoments from "@/app/components/moments/ModalSelectMoments";
import AddOutlineSvg from "@/app/assets/svgs/add-outline.svg";

const PickerMultiMoments = ({
  onMomentSelect,
  containerText = "ADD MOMENTS",
  ...
  const oneThirteenthHeight = height / 13;
  ...
  useEffect(() => {
    const initialSelectedMoments = allCapsulesList.filter((capsule) =>
  ...
  useEffect(() => {
    const uniqueCategories = [
      ...new Set(allCapsulesList.map((capsule) => capsule.typedCategory)),
    ];
  ...
  const handleCategoryPress = (category) => {
    ...
    const items = allCapsulesList.filter(
