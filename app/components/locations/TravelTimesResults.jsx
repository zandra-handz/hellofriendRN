  ...
  const renderComparisonResults = () => {
        ...
        >
          <Text
            style={[
              ...
              { color: lightDarkTheme.primaryText, fontSize: fontSize },
            ]}
          >
            {headerText}
          </Text>
          ...
          >
            ...
            <Text
              style={[
                ...
                { color: lightDarkTheme.primaryText, marginLeft: "4%", fontSize: fontSize },
              ]}
            >
              {travelTimesData.time}
            </Text>
          </View>
          <View
            style={{
          ...
          >
            <Text
              style={[
                styles.resultsText, 
                {color: lightDarkTheme.primaryText, fontWeight: "bold", fontSize: fontSize / 1.5 },
              ]}
            >
              {travelTimesData.miles}les
            </Text>
          </View>
        </View>
      );
    ...
    return (
      <View style={styles.container}>
        {userTravelTime && <>{ResultsCard("Me", userTravelTime)}</>}

        {friendTravelTime && <>{ResultsCard(friendName, friendTravelTime)}</>}
      </View>
    );
  };
