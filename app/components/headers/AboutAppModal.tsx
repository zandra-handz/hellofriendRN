      ...
      <AlertFormNoSubmit
        ...
        formBody={
          <ScrollView contentContainerStyle={styles.bodyContainer}>
            ...
            <View style={styles.sectionContainer}>
              <Text style={[styles.text, themeStyles.genericText]}>
                Specifically, it refers to those moments when something reminds
                us of a person who has the audacity to not be anywhere near us
                at the time for us to tell them. These types of moments can
                accumulate over time if mostly-forgotten and never shared, and
                leave us with a sense of sadness we have lost the ability to
                pinpoint.
              </Text>
            </View>
            ...
            <View style={styles.sectionContainer}>
              <Text style={[styles.text, themeStyles.genericText]}>
                That sounds all deep and stuff, but a moment can be as serious
                or as silly as you'd like!
              </Text>
            </View>
            <View style={styles.sectionContainer}>
              <Text style={[styles.text, themeStyles.genericText]}>
            ...
            <View style={styles.sectionContainer}>
              <Text style={[styles.text, themeStyles.genericText]}>
                ...
                ultimately intended for helping encourage and facilitate
                in-person interactions. For the people in our lives we
                especially want to make an effort to see more of than we do and
                we're not sure how; or for whom timing is a bit more complex of
                a factor.
              </Text>
            </View>
            <View style={styles.sectionContainer}>
            ...
            <View style={styles.sectionContainer}>
              <Text style={[styles.text, themeStyles.genericText]}>
                Hellofriend can: search and save locations, pin favorite
                locations to individual friend dashboards, calculate the
                difference in travel times between you and your friend for any
                given location, and also find midpoint locations between you and
                your friend if you would rather choose one this way. You can
                also add your own notes and a parking score to each location for
                future reference.
              </Text>
            </View>
            <View style={styles.headerContainer}>
            ...
            <View style={styles.sectionContainer}>
              <Text style={[styles.text, themeStyles.genericText]}>
                You can take and store pictures with the app itself, keeping
                them separate from gallery on your phone and avoiding
                clutter/making retrieval easier, if you struggle with this sort
                of thing.
              </Text>
            </View>
            <View style={styles.headerContainer}>
            ...
            <View style={styles.sectionContainer}>
              <Text style={[styles.text, themeStyles.genericText]}>
                (The app will also simply regenerate if you miss a date. They
                are just suggestions. Missing them means absolutely nothing to
                the app. It will not count against you in any way.)
              </Text>
            </View>
