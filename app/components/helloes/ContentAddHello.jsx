...
// redirection afterwards comes from the deselect in useCreateHello and cache resetting. autoHandler runs after
// this will not reset any of the auto select settings!
const ContentAddHello = ({ userId, primaryColor, backgroundColor }) => {
  ...
  const {  handleCreateHello } = useCreateHello({
    userId: userId,
  });
