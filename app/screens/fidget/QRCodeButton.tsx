...
const QRCodeButton = ({color='red', backgroundColor='orange', onPress,  buttonDiameter=40, buttonPadding=20, iconSize=20}: Props) => {
  ...
  return (
    <Pressable onPress={onPress} style={[styles.manualButton, {height: buttonDiameter, width: buttonDiameter, backgroundColor: backgroundColor, padding: buttonPadding}]}>
        <SvgIcon name={`qrcode_scan`} color={color} size={iconSize} />
